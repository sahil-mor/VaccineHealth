...
options.colors = ['#089bab', '#FC9F5B','#6c757d','#ffc107', '#dc3545', '#343a40', '#20c997', '#6f42c1'];
  ...
  jQuery("#home-servey-chart").length && am4core.ready(function() {
   ...
   jQuery("#patient-chart-1").length && am4core.ready(function() {
    var options = {
          series: [{
          name: 'Servings',
          data: [4, 5, 8, 10, 11, 11, 17, 20, 21, 22]
        }],
          annotations: {
          points: [{
            x: 'Bananas',
